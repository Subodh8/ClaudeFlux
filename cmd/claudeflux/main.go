...
// Dummy commands to make main compile
func resumeCmd() *cobra.Command { return &cobra.Command{Use: "resume"} }
func logsCmd() *cobra.Command { return &cobra.Command{Use: "logs"} }
func runsCmd() *cobra.Command { return &cobra.Command{Use: "runs"} }
func approveCmd() *cobra.Command { return &cobra.Command{Use: "approve"} }
func rejectCmd() *cobra.Command { return &cobra.Command{Use: "reject"} }
func statusCmd() *cobra.Command { return &cobra.Command{Use: "status"} }
func validateCmd() *cobra.Command { return &cobra.Command{Use: "validate"} }
func estimateCmd() *cobra.Command { return &cobra.Command{Use: "estimate"} }
